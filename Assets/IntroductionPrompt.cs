...
{
    public string[] lines = { "Welcome to our village!", "We've been expecting you.", "Please make yourself at home.", "Let me show you around town." };   // Array of dialogue lines for this prompt
