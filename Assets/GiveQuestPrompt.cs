...
{
    public static string[] lines = { "Watch out for the dragons!", "The forest can be dangerous.", "We're low on supplies.", "We need someone brave to help us." };   // Array of dialogue lines for this prompt
