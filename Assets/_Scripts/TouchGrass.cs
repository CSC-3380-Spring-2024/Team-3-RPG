...
{
    public static string[] lines = { "Check your screen time. I can smell you.", "Go outside and touch some grass. There's an obvious one you should touch." };    // Array of dialogue lines for the IntroductionPrompt
